...
in case of modification, you have to drop every db and start over, following:
////////////////////////////////////////////////////////////////////////////////////////////////
-- ==========================================
-- LEVEL 5: The most dependent tables
-- ==========================================
DROP TABLE IF EXISTS Adoption;

-- ==========================================
-- LEVEL 4: Depend on Medical Records & Medicine
-- ==========================================
DROP TABLE IF EXISTS Prescription;
DROP TABLE IF EXISTS Lab_Test;

-- ==========================================
-- LEVEL 3: Depend on Animal, Appointment, Bill
-- ==========================================
